...
UnderWorld는 Unity 2D 기반의 멀티플레이어 생존 RPG 게임입니다.

심해를 배경으로 플레이어들은 위험으로 가득한 수중 세계를 탐험하며 생존을 위해 싸웁니다. 

Photon Engine을 활용한 실시간 멀티플레이 시스템과 Spring Boot 백엔드를 통합하여 안정적이고 끊김 없는 네트워크 환경을 구현했습니다.

게임 내에서 플레이어들은 다양한 심해 지형을 탐험하며 몬스터를 처치하고, 자원을 수집하여 생존에 필요한 도구와 아이템을 직접 제작할 수 있습니다. 혼자서도 플레이가 가능하지만, 다른 플레이어들과 협력하면 더욱 강력한 적들을 상대하고 희귀한 자원이 있는 위험 지역을 탐험할 수 있습니다.
                 
모든 그래픽 에셋은 Aseprite를 활용하여 직접 제작한 픽셀 아트 스타일로 구성되어 있으며, 직관적인 조작 시스템으로 누구나 쉽게 게임을 즐길 수 있도록 설계했습니다. 
